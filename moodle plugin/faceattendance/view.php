...
$modelprofile = !empty($faceattendance->modelprofile) ? $faceattendance->modelprofile : 'fast_short';
$modelprofilelabel = $profilelabels[$modelprofile] ?? $profilelabels['fast_short'];

$embedding = $DB->get_record('faceattendance_embeddings', [
...
if ($canmanage || $cantakeattendance) {
    echo $OUTPUT->notification(get_string('selectedmodelprofile', 'faceattendance', $modelprofilelabel), 'info');
}
