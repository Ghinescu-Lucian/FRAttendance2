...
try {
    ...
    $PAGE->set_url(new moodle_url('/mod/faceattendance/api/station_unknown.php'));
    ...
    $DB->insert_record('faceattendance_detections', (object)[
        ...
        'distance' => 0,
        'source' => $source,
        'rawpayload' => json_encode(array_diff_key($payload, ['thumbnail' => true]) + ['stationid' => $stationid], JSON_UNESCAPED_SLASHES),
        'timecreated' => $now,
    ]);
