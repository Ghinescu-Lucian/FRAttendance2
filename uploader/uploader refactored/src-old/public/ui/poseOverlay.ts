import { EnrollmentView } from "./dom.js";

export function installPoseTextOverlayOnly(view: EnrollmentView): void {
  const host = view.video.parentElement;
  if (!host || document.getElementById("poseTextOverlayOnlyStyles")) return;
