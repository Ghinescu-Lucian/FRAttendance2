...
export class EnrollmentView {
  ...
  private drawOverlay(): void {
    ...
    this.drawFaceGuide(ctx, width, height);
  ...
  private drawDirectionGesture(
    ...
    this.drawHandEmoji(ctx, handX, handY - 28, hand);
  ...
  private drawHandEmoji(ctx: CanvasRenderingContext2D, x: number, y: number, hand: string): void {
    ctx.save();
