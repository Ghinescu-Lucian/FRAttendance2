import { ENROLLMENT_APP_BUILD, SFACE_SIZE } from "../config/appConfig.js";
import { descriptorNorm } from "../utils/math.js";
export class EnrollmentApi {
    async uploadImage(identity, blob, frameIndex, pose) {
    ...
    async uploadEmbeddingFile(identity, embeddings) {
    ...
    async completeEnrollment(identity) {
    ...
    buildPayload(identity, embeddings) {
        return {
            version: 2,
