...
const resultName = resultBox.querySelector(".result-name");
...
function recognizeDescriptor(descriptor) {
...
function showRecognition(name, distance, extra) {
...
async function recognitionLoop() {
    ...
    const recognition = recognizeDescriptor(result.descriptor);
    showRecognition(recognition.name, recognition.distance, recognition.name === "Unknown" ? "No match." : `Matched pose: ${recognition.pose}`);
}
...
void loadKnownEmbeddings().catch((err) => {
    console.warn(err);
