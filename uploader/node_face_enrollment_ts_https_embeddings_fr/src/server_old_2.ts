...
const SERVER_BUILD = "strict-sface-upload-2026-05-06";
...
app.get("/api/health", (_req: Request, res: Response) => {
  res.json({ ok: true, serverBuild: SERVER_BUILD, uploadDir: UPLOAD_DIR, https: Boolean(HTTPS_KEY_FILE && HTTPS_CERT_FILE) });
});
