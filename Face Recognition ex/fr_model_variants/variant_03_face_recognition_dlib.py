...
def main() -> None:
    ...
    gallery = build_gallery(Path(args.subjects_dir), face_recognition, args.model)
    ...
    while True:
        ...
        locations = face_recognition.face_locations(rgb_small, model=args.model)
        ...
        cv2.putText(
            frame,
            f"dlib face_recognition {args.model} | faces={len(locations)} | fps={current_fps:.1f} | ESC exit",
            (20, 35),
