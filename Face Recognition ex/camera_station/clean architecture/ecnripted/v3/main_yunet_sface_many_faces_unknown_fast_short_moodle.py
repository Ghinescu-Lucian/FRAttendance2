...
def _moodle_signed_headers(method, url, body=b""):
    ...
    if not MOODLE_API_SECRET or MOODLE_API_SECRET == "change-this-secret":
        raise RuntimeError("Missing Moodle API secret. Set api_secret in station_config.json or FACEATTENDANCE_API_SECRET.")
