...
# ============================================================
# DETECT MANY FACES: OpenCV YuNet + SFace + full-frame display
# ============================================================
# Goal:
...
#   5. Use multi-scale/grid crop search only to help small or far faces,
#      not to lock the UI on one target.
#
# This version uses:
...
FULL_GRID_SEARCH_EVERY_N_FRAMES = 8

# Search zooms.
SEARCH_ZOOM_LEVELS_FAST = [1.0, 1.8, 2.6]
SEARCH_ZOOM_LEVELS_FULL = [1.0, 1.6, 2.2, 3.0, 4.0]
...
CANDIDATE_IOU_DEDUPE_THRESHOLD = 0.55
...
def main():
    ...
    print("Detect-many mode: full-frame display, no single face lock, no entrance-zone filtering.\n")
    ...
    while True:
        ...
        if should_full_grid_search:
            status += " | full grid search"
        else:
            status += " | full/fast search"
